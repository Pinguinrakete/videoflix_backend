...
### 5. Create a virtual environment for create a secret key.
### Windows 10/11
```bash
py -3.11 -m venv env   
...
### 8. Starting the Docker container
...
### 9. Access to Backend and Admin Panel
...
### ![Quiz Icon](assets/icons/quiz.png) 10. License
